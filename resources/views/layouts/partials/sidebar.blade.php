    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar pt-3">
        <nav class="space-y-1.5 px-3 pb-6">
            ...
            @canany(['view-admin-dashboard', 'view-products', 'view-recipes', 'view-categories', 'view-orders', 'manage-orders', 'view-users'])
                ...
                {{-- Productos --}}
                @can('view-products')
                    <a href="{{ route('admin.products.index') }}" class="sidebar-nav-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('products.*') ? 'bg-orange-600 text-white shadow-md shadow-orange-950/30' : 'text-stone-400 hover:text-stone-200 dark:hover:text-stone-200 hover:bg-stone-800/60' }}">
                ...
                {{-- Recetas --}}
                @can('view-recipes')
                    <a href="{{ route('admin.recipes.index') }}" class="sidebar-nav-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('recipes.*') ? 'bg-orange-600 text-white shadow-md shadow-orange-950/30' : 'text-stone-400 hover:text-stone-200 dark:hover:text-stone-200 hover:bg-stone-800/60' }}">
                ...
                {{-- Categorías --}}
                @can('view-categories')
                    <a href="{{ route('admin.categories.index') }}" class="sidebar-nav-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('categories.*') ? 'bg-orange-600 text-white shadow-md shadow-orange-950/30' : 'text-stone-400 hover:text-stone-200 dark:hover:text-stone-200 hover:bg-stone-800/60' }}">
                ...
                {{-- Órdenes --}}
                @can('view-orders')
                    <a href="{{ route('admin.orders.index') }}" class="sidebar-nav-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('orders.*') ? 'bg-orange-600 text-white shadow-md shadow-orange-950/30' : 'text-stone-400 hover:text-stone-200 dark:hover:text-stone-200 hover:bg-stone-800/60' }}">
