<div class="p-6 border-b border-slate-100 dark:border-stone-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
        <div class="flex items-center gap-3 flex-wrap">
            <h2 class="text-xl font-bold text-slate-900 dark:text-stone-100">{{ $category->name }}</h2>
            <span class="bg-orange-50 dark:bg-orange-950/50 text-orange-700 dark:text-orange-300 text-xs font-mono font-semibold px-2.5 py-1 rounded-lg border border-orange-200/60 dark:border-orange-900/50">
                Slug: {{ $category->slug }}
            </span>
        </div>
