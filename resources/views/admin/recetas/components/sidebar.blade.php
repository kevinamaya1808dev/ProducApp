<div class="lg:col-span-4 space-y-4">
    ...
    <div class="space-y-3 max-h-[calc(100vh-250px)] overflow-y-auto pr-1">
        ...
        @empty
            <div class="bg-white dark:bg-stone-900 border border-slate-200 dark:border-stone-800 rounded-2xl p-6 text-center text-slate-500 dark:text-stone-400 text-sm shadow-sm">No se encontraron recetas registradas.</div>
        @endforelse
    </div>
</div>