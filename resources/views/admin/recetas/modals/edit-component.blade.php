            ...
            <form action="{{ route('recipes.components.update', [$recipe->id, $component->id]) }}" method="POST">
                ...
                <div class="px-6 py-6 space-y-5">
                    <div>
                        ...
                        <input type="text" name="name" required value="{{ $component->name }}" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none text-slate-700">
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
    <label class="block text-sm font-semibold text-slate-700 mb-2">Tipo</label>
    <select name="component_type_id" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none text-slate-700 bg-white">
        ...
        @endforeach
                        ...
                        <div>
                            ...
                            <select name="base_unit" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none text-slate-700 bg-white">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0.01" name="quantity" required value="{{ $component->pivot->quantity }}" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none text-slate-700">
                    </div>
                </div>
                <div class="px-6 py-4 border-t border-slate-100 flex items-center justify-end gap-3 bg-slate-50 rounded-b-2xl">
                    ...
                    <button type="submit" class="px-5 py-2.5 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 shadow-sm shadow-blue-600/30">Guardar</button>
                </div>
            </form>
        </div>
    </div>
