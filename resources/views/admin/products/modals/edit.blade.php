<div id="modal-edit" class="fixed inset-0 z-50 hidden bg-slate-900/50 backdrop-blur-sm overflow-y-auto items-center justify-center p-4">
    <div class="relative bg-white dark:bg-stone-900 rounded-xl shadow-xl w-full max-w-2xl transform transition-all border border-slate-200 dark:border-stone-800">
        <div class="px-6 py-4 border-b border-slate-100 dark:border-stone-800 flex items-center justify-between">
            <h3 class="text-lg font-bold text-slate-900 dark:text-stone-100">Editar Producto</h3>
            <button onclick="closeModal('modal-edit')" type="button" class="text-slate-400 dark:text-stone-400 hover:text-slate-500 dark:hover:text-stone-200 transition-colors">
        ...
        <form id="edit_product_form" method="POST">
            ...
            <div class="px-6 py-4 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text" id="edit_name" name="name" required class="w-full px-3 py-2 bg-slate-50 dark:bg-stone-800 border border-slate-200 dark:border-stone-700 rounded-lg text-sm text-slate-700 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-orange-500">
                    </div>

                    <div class="col-span-2 md:col-span-1">
                        <label class="block text-xs font-semibold text-slate-700 dark:text-stone-300 mb-1">Código único *</label>
                        <input type="text" id="edit_code" name="code" required class="w-full px-3 py-2 bg-slate-50 dark:bg-stone-800 border border-slate-200 dark:border-stone-700 rounded-lg text-sm text-slate-700 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-orange-500">
                    </div>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="number" id="edit_unit_cost" step="0.01" min="0" name="unit_cost" required class="w-full px-3 py-2 bg-slate-50 dark:bg-stone-800 border border-slate-200 dark:border-stone-700 rounded-lg text-sm text-slate-700 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-orange-500">
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="edit_description" name="description" rows="3" class="w-full px-3 py-2 bg-slate-50 dark:bg-stone-800 border border-slate-200 dark:border-stone-700 rounded-lg text-sm text-slate-700 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-4 bg-slate-50 dark:bg-stone-800/50 rounded-b-xl border-t border-slate-100 dark:border-stone-800 flex justify-end gap-3">
                <button type="button" onclick="closeModal('modal-edit')" class="px-4 py-2 text-xs font-semibold text-slate-600 dark:text-stone-300 bg-white dark:bg-stone-800 border border-slate-200 dark:border-stone-700 rounded-lg hover:bg-slate-50 dark:hover:bg-stone-700 transition-colors">Cancelar</button>
