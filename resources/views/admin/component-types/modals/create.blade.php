            ...
            <form action="{{ route('component-types.store') }}" method="POST">
                ...
                <div class="px-6 py-6 space-y-5">
                    <div>
                        ...
                        <input type="text" name="name" required placeholder="Ej: Empaque" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none text-slate-700">
                    </div>
                ...
                <div class="px-6 py-4 border-t border-slate-100 flex justify-end gap-3 bg-slate-50 rounded-b-2xl">
                    ...
                    <button type="submit" class="px-5 py-2.5 text-sm font-semibold text-white bg-orange-600 rounded-lg hover:bg-orange-700">Crear</button>
                </div>
            </form>
        </div>
    </div>
