<div id="deleteOrderModal" class="fixed inset-0 z-50 overflow-y-auto" style="display:none;" role="dialog" aria-modal="true">
        ...
        <div class="inline-block align-bottom bg-white dark:bg-stone-900 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md w-full border border-slate-200 dark:border-stone-800">
            <form id="deleteOrderForm" action="#" method="POST">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-bold text-slate-900 dark:text-stone-100 text-center mb-2">¿Eliminar orden?</h3>
                    <p class="text-sm text-slate-500 dark:text-stone-400 text-center">
                        Estás a punto de eliminar la orden <span id="deleteOrderNumber" class="font-semibold text-slate-700 dark:text-stone-200"></span>. Esta acción no se puede deshacer.
                    </p>
                </div>
                ...
                <div class="px-6 py-4 bg-slate-50 dark:bg-stone-800/50 border-t border-slate-100 dark:border-stone-800 flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-5 py-2 bg-red-600 text-white rounded-lg text-sm font-medium hover:bg-red-700 shadow-md shadow-red-600/20 transition-colors">Sí, Eliminar</button>
                </div>
            </form>
        </div>
    </div>
