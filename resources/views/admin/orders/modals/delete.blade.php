        ...
        <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md w-full border border-slate-200">
            <form id="deleteOrderForm" action="#" method="POST">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-bold text-slate-900 text-center mb-2">¿Eliminar orden?</h3>
                    <p class="text-sm text-slate-500 text-center">
                        Estás a punto de eliminar la orden <span id="deleteOrderNumber" class="font-semibold"></span>. Esta acción no se puede deshacer.
                    </p>
                </div>
