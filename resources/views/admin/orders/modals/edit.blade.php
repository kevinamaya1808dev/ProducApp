            ...
            <form id="editOrderForm" method="POST">
                ...
                <div class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                    <div>
                        ...
                        <input type="text" id="editOrderNumber" name="order_number" required placeholder="Ej: ORD-2026-0001" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-1">Producto a fabricar <span class="text-red-500">*</span></label>
                        <select id="editProductId" name="product_id" required class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" id="editQuantity" name="quantity" min="1" required placeholder="Ej. 500" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1">Prioridad <span class="text-red-500">*</span></label>
                            <select id="editPriority" name="priority" required class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                        ...
                        <div>
                            ...
                            <select id="editUserId" name="user_id" required class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                        ...
                        <div>
                            ...
                            <select id="editStatus" name="status" required class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                        ...
                        <div>
                            ...
                            <input type="text" id="editEstacion" name="estacion" placeholder="Ej: Estación 4" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1">Fecha Inicio</label>
                            <input type="date" id="editStartDate" name="start_date" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1">Fecha Límite</label>
                            <input type="date" id="editEndDate" name="end_date" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-5 py-2 bg-orange-600 text-white rounded-lg text-sm font-medium hover:bg-orange-700 shadow-sm">Actualizar Orden</button>
                </div>
            </form>
        </div>
    </div>
