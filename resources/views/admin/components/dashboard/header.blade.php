<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    <div>
        <h1 class="text-2xl font-bold text-stone-900 dark:text-stone-100">Resumen de Producción</h1>
    ...
    <div class="flex items-center gap-3">
        <!-- Filtrar -->
        <button type="button" onclick="openModal('filter-modal')" class="inline-flex items-center gap-2 px-3.5 py-2 bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-lg text-xs font-semibold text-stone-700 dark:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-800 shadow-sm transition-colors">
