        ...
        <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl w-full border border-slate-200">
            <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="name" required value="{{ old('name') }}" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-blue-500" placeholder="Ej. Juan Pérez">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input type="email" name="email" required value="{{ old('email') }}" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-blue-500" placeholder="correo@producapp.com">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <select name="turno" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-blue-500">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="notas" rows="2" placeholder="Habilidades, observaciones..." class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-blue-500"></textarea>
                        </div>
                    ...
                    <div class="border-t border-slate-100 pt-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100">
                            @forelse($permissions as $permission)
                                <label class="flex items-center gap-3 p-2 bg-white rounded-lg border border-slate-200 cursor-pointer">
                                    <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" class="w-4 h-4 text-blue-600 rounded border-slate-300">
                ...
                <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-5 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">Crear Operario</button>
                </div>
            </form>
        </div>
    </div>
