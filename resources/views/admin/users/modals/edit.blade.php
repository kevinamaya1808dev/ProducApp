                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="editName" name="name" required class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-slate-700 mb-1">Rol <span class="text-red-500">*</span></label>
                                <select id="editRoleId" name="role_id" required class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input type="email" id="editEmail" name="email" required class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-slate-700 mb-1">Estado de la cuenta <span class="text-red-500">*</span></label>
                                <select id="editActive" name="active" required class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-orange-500">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100">
                            @foreach(['Ensamblaje', 'Control de Calidad', 'Soldadura', 'Empaque y Etiquetado', 'Mantenimiento Preventivo', 'Operación de CNC'] as $skillOption)
                                <label class="flex items-center gap-3 p-2 bg-white rounded-lg border border-slate-200 cursor-pointer">
                                    <input type="checkbox" name="skills[]" value="{{ $skillOption }}" class="edit-skill-checkbox w-4 h-4 text-orange-600 rounded border-slate-300">
                    ...
                    <div class="border-t border-slate-100 pt-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100">
                            @forelse($permissions as $permission)
                                <label class="flex items-center gap-3 p-2 bg-white rounded-lg border border-slate-200 cursor-pointer">
                                    <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" class="permission-checkbox w-4 h-4 text-orange-600 rounded border-slate-300">
