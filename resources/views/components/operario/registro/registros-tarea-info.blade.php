    ...
    @if($tarea)
        ...
        <div class="p-5">
            <div class="flex justify-between items-end mb-2">
                <span class="text-xs font-bold text-stone-400 uppercase tracking-wide">Avance Total</span>
                <div class="text-right">
                    <span class="text-2xl font-bold text-stone-800">{{ $tarea['actual'] }}</span>
                    <span class="text-stone-400 text-sm">/{{ $tarea['total'] }}</span>
                </div>
            </div>
            ...
            <div class="text-right text-xs font-bold text-orange-600">{{ round($porcentaje) }}%</div>
        </div>
    @else
