...
<div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
    ...
    <div class="space-y-5">
        ...
        <div class="flex justify-between items-center">
            ...
            <span class="text-lg font-bold text-slate-800">{{ $piezasHoy }}</span>
        </div>
        ...
        <div>
            <div class="flex justify-between items-center mb-2">
                ...
                <span class="text-sm font-bold text-slate-800">{{ $eficiencia }}%</span>
            </div>
        ...
        <div class="flex justify-between items-center pt-1">
            ...
            <span class="text-lg font-bold {{ $incidenciasHoy > 0 ? 'text-amber-600' : 'text-slate-800' }}">
                {{ $incidenciasHoy }}
            </span>
        </div>
    </div>
